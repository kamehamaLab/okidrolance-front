...
const DeviceList: React.FC  = () =>{
  ...
  return (
    <>
    <ul id="deviceSelectRadio" className="items-center w-full text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg sm:flex dark:bg-gray-700 dark:border-gray-600 dark:text-white">
      {devices.map((device)=>(
